<a href="{{ route('tahun_ajaran.ubah', $tahunAjaran->id) }}" class="btn btn-link btn-sm text-secondary text-xs p-0 m-0">
    <div
...
<button data-href="{{ route('tahun_ajaran.hapus', $tahunAjaran->id) }}" class="btn btn-link btn-sm text-secondary text-xs p-0 m-0" onclick="deleteData(this, 'reloadTable()')">
    <div
