<x-app-layout>
    <x-main :title="__('Tambah Kriteria')" :isPrevious="true">
        <div class="row mt-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-0">
                        <x-form-ajax :method="__('POST')"
                            action="{{ route('kriteria.proses_tambah') }}"
                            ...
                            <div class="mb-3">
                                <label for="jenis-kriteria" class="form-label text-uppercase text-secondary">Jenis Kriteria</label>
                                <select name="id_jenis_kriteria" id="jenis-kriteria" class="form-select" aria-label="Pilih jenis kriteria">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukan nama kriteria">
                ...
                <div id="keterangan" class="row">
                    <div class="col-12 mb-4">
                        <div class="card">
                            <div class="card-header pb-0">
                                <h6>
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#ket-jenis-kriteria"
                                        aria-expanded="true" aria-controls="ket-jenis-kriteria">
                                        Keterangan Jenis Kriteria
                                    </button>
                                </h6>
                            </div>
                            <div id="ket-jenis-kriteria" class="card-body py-0 accordion-collapse collapse show" data-bs-parent="#keterangan">
                                <table class="table table-borderless">
                                    <thead>
                                        <tr>
                                            <th class="align-middle text-uppercase text-secondary text-xs font-weight-bolder px-0">Jenis
                                            </th>
                                            <th class="align-middle text-uppercase text-secondary text-xs font-weight-bolder px-0">
                                                Keterangan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($jenisKriteria as $item)
                                        <tr>
                                            <td class="align-middle text-secondary text-xs font-weight-bold text-wrap px-0">{{ $item->nama }}</td>
                                            <td class="align-middle text-secondary text-xs font-weight-bold text-wrap px-0">{{ $item->keterangan }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="col-12 mb-4">
                        <div class="card">
                            ...
                            <div id="ket-nilai-bobot" class="card-body py-0 accordion-collapse collapse" data-bs-parent="#keterangan">
                                <table class="table table-borderless">
                                    <thead>
                                        <tr>
