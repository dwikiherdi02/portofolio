<x-app-layout>
    ...
    <script>
        let tableList;
        const url = {
            "datatables": `{{ route('hasil_biaya_spp.datatabel') }}`,
        };
    </script>
    <script src="{{ asset('assets/js/pages/proses-penentuan/hasil.list.js') }}"></script>
    @endpush
</x-app-layout>