<x-app-layout>
    <x-main :title="__('Ubah Opsi Kriteria - '.$kriteria->nama)" :isPrevious="true">
        <div class="row mt-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-0">
                        <x-form-ajax :method="__('PUT')"
                            action="{{ route('kriteria.opsi.proses_ubah', [$kriteria->id, $nilaiKriteria->id]) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kode" id="kode" class="form-control" value="{{ $nilaiKriteria->kode }}" placeholder="Otomatis" disabled>
                            </div>
                            <div class="mb-3">
                                <label for="keterangan" class="form-label text-uppercase text-secondary">Keterangan (Nama Opsi)</label>
                                <input type="text" name="keterangan" id="keterangan" class="form-control" value="{{ $nilaiKriteria->keterangan }}" placeholder="Masukan nama opsi">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="bobot" id="bobot" class="form-select" aria-label="Pilih nilai bobot">
                                    ...
                                    @php
                                        $selected = ($item->nilai == $nilaiKriteria->bobot) ? 'selected' : '';
                                    @endphp
